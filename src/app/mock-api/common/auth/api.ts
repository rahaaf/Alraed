    ...
    registerHandlers(): void
    {
        ...
        this._fuseMockApiService
            ...
            .reply(({request}) => {
                ...
                // Sign in successful
                if ( request.body.email === 'abbott@withinpixels.com' && request.body.password === 'admin' )
                {
                    return [
                        200,
                        {
               ...
               else if ( request.body.email === 'hughes.brian@company.com' && request.body.password === 'store' )
               {
                return [
                    200,
                    {
               ...
               else if ( request.body.email === 'abbott@withinpixels.com' && request.body.password === 'hall' )
               {
                return [
                    200,
                    {
