...
import { InventoryPagination, InventoryProduct } from 'app/modules/manager store/addoutgoingmerchandise/addoutgoingmerchandise/inventory.types';
import { InventoryService } from 'app/modules/manager store/addoutgoingmerchandise/addoutgoingmerchandise/inventory.service';
...
export class InventoryListComponent implements OnInit, AfterViewInit, OnDestroy
{
    ...
    uploadImage(f: NgForm) {
        ...
        this.selectedProductForm.get('images').setValue(myFormData,headers);
    ...
    deleteSelectedProduct(): void
    {
        ...
        const confirmation = this._fuseConfirmationService.open({
            ...
            message: 'Are you sure you want to remove this goods? This action cannot be undone!',
            actions: {
                confirm: {
                    label: 'Delete'
                }
